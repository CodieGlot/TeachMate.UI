...
export function ReceiveFeedback() {
  ...
  return (
    <div className="bg-gray-100 flex justify-center items-center min-h-screen p-10">
      <div className="md:w-3/5 w-3/4 p-10 bg-gradient-to-r from-sky-400/20 to-indigo-600/20 text-white rounded-lg shadow-md">
        <h1 className="bg-gradient-to-r to-indigo-600 from-sky-400 bg-clip-text text-transparent text-xl font-bold">Reviews Feedbacks</h1>
