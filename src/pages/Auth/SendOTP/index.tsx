...
export function SendOTP() {
    ...
    const [gmailReceiveOTP, setEmail] = useState('');
    ...
    const handleSaveClick = async () => {
        ...
        try {
            ...
            SendOTPservice.SendOTP({ gmailReceiveOTP }
                            ...
                            <div className="grid gap-y-4">
                                <div>
                                    ...
                                    <div className="relative">
                                        <input value={gmailReceiveOTP}  // Bind input value to state variable
