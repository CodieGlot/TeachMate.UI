                        ...
                        <div className="container flex flex-col mx-auto md:flex-row md:items-center md:justify-between">
                            <div className="flex items-center justify-between">
                                <div style={{ display: 'flex', alignItems: 'center' }}>
                                    <img className="h-12 w-auto indigo-400" src="src/assets/Group.svg" alt="" onClick={handleHome} />
                                ...
                                <div><nav className="bg-white border-gray-200 px-4 lg:px-6 py-2.5 dark:bg-gray-800">
                                    <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl" style={{ marginLeft: '300px' }}>
                                        ...
                                        <div className="hidden justify-between items-center w-full lg:flex lg:w-auto lg:order-1" id="mobile-menu-2">
                                            <ul className="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0">
                                                <li>
                                                    <a href="#" className="block bg-gradient-to-r from-sky-400 to-indigo-600 bg-clip-text text-transparent text-xl font-bold" onClick={handleHome}>Home</a>
                                                </li>
                                                <li>
                                                    <a href="#" className="block bg-gradient-to-r from-sky-400 to-indigo-600 bg-clip-text text-transparent text-xl font-bold">Marketplace</a>
                                                </li>
                                                <li>
                                                    <a href="#" className="block bg-gradient-to-r from-sky-400 to-indigo-600 bg-clip-text text-transparent text-xl font-bold">Features</a>
                                                </li>
                                                <li>
                                                    <a href="#" className="block bg-gradient-to-r from-sky-400 to-indigo-600 bg-clip-text text-transparent text-xl font-bold">Team</a>
                                                </li>
                                                <li>
                                                    <a href="#" className="block bg-gradient-to-r from-sky-400 to-indigo-600 bg-clip-text text-transparent text-xl font-bold">Contact</a>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
