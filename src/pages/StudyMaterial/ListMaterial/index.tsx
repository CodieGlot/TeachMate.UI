...
//       <img src='https://tailwindcomponents.com/svg/logo-color.svg' className='h-8' alt='Logo' />
...
//         className='flex items-center text-gray-600 w-full border-b overflow-hidden mt-32 md:mt-0 mb-5 mx-auto cursor-pointer'
//       >
//         <div className={`w-10 border-r px-2 transform transition duration-300 ease-in-out ${reportsOpen ? 'rotate-90' : ''}`}>
//           <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-6 h-6">
//             <path strokeLinecap="round" strokeLinejoin="round" d="M19.5 8.25l-7.5 7.5-7.5-7.5" />
//           </svg>          
//         </div>
//         <div className='flex items-center px-2 py-3'>
//           <div className='mx-3'>
//             <button className="hover:underline">This is where you click to open</button>
//           </div>
//         </div>
//       </div>

//       <div className={`flex p-5 md:p-0 w-full transform transition-all duration-500 ease-in-out border-b pb-10 ${reportsOpen ? 'max-h-96' : 'max-h-0 overflow-hidden'}`}>
//         <p className={`transition-opacity duration-500 ease-in-out ${reportsOpen ? 'opacity-100' : 'opacity-0'}`}>
