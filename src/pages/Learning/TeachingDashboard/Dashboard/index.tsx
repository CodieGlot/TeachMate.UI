      ...
      <section className="bg-white dark:bg-gray-900">
        <div className="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
          <div className="max-w-screen-md mb-8 lg:mb-16">
            <h2 className="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white"><span className="text-indigo-400">Teaching</span> as your passion</h2>
          ...
          <div className="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0">
            ...
            <div className="rounded border border-slate-300 hover:border-indigo-300 p-5 hover:cursor-pointer hover:bg-indigo-100">
              ...
              <h3 className="mb-2 text-xl font-bold dark:text-white">Create new class</h3>
              <p className="text-gray-500 dark:text-gray-400">Want to teach? </p>
            </div>
            </a>
            ...
            <div className="rounded border border-slate-300 hover:border-indigo-300 p-5 hover:cursor-pointer hover:bg-indigo-100">
              ...
              <h3 className="mb-2 text-xl font-bold dark:text-white">Manage your class</h3>
              <p className="text-gray-500 dark:text-gray-400">View and update detail of your created classes</p>
            </div>
            </a>
            <a href="/schedule">
            <div className="rounded border border-slate-300 hover:border-indigo-300 p-5 hover:cursor-pointer hover:bg-indigo-100">
